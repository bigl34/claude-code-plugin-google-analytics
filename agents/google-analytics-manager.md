...
- **Website**: YOUR_COMPANY.com (rebranding to YOUR_COMPANY)
- **Business**: UK-based e-commerce selling products
- **Key metrics**: Revenue, conversions, traffic sources, product performance
- **Comparison periods**: Week-over-week and month-over-month useful for trends
...
Log to: `/home/USER/biz/plugin-learnings/google-analytics-manager.md`
